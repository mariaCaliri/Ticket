...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="content">
                <form action="{{ route('admin.operatore.update',$operator->id) }}" method="POST"
                ...
                @enderror
                    <strong>Email Operatore:</strong>
                    <input type="text" name="email" value="{{ $operator->email }}" class="form-control"
                           placeholder="Email">
                    @error('name')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
